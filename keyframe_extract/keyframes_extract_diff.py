...
def extract_keyframes(videopath):
    ...
    dir = './keyframe_extract/extract_result/'
    output_video = './keyframe_extract/extract_result/output.mp4'
    ...
    cap.release()
    out.release()
    print("extract key frames success")
    return output_video
